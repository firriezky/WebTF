    ...
    <div class="page-inner py-5">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
            <div>
                ...
                <h5 class="text-white op-7 mb-2">Hallo {{ Auth::guard('student')->user()->name }}, <br> Ahlan wa Sahlan <br>
                </h5>
            </div>
        ...
        <div class="col-md-12">
            <div class="card full-height">
                <div class="card-header">
                    ...
                    <a href="{{url('mentor/tahfidz/task/')}}">Untuk Melihat Semua Setoran Terbaru Klik Disini</a></h4>
                    <br><br>
                </div>
                <div class="card-body">
